...
tasks = [
    dict(num_class=15, class_names=["Pelvis", "Right_Hip", "Right_Knee", "Right_Ankle", "Left_Hip", \
                                    "Left_Knee", "Left_Ankle", "Thomx", "Head", "Right_Shoulder", "Right_Elbow", \
...
DATASET = dict(
  DIR=dict(
    ROOT_DIR=str(REPO_ROOT / 'datasets'),
    META_FILE='filemeta.json',
    KEYPOINT_META='Keypoints_meta.txt',
    SEQUENCES_DIR='GT_sequences',
    RADAR='radar',
    RDR_CUBE_DIR='npy_DZYX_complex',
  ),
  LABEL= dict(
